...
CREATE DATABASE IF NOT EXISTS spells_test_db;
USE spells_test_db;
...
-- Test auth service user
CREATE USER IF NOT EXISTS 'auth_test_user'@'%' IDENTIFIED BY 'auth_test_password';
GRANT SELECT, INSERT, UPDATE, DELETE ON auth_test_db.* TO 'auth_test_user'@'%';

-- Test spell service user
CREATE USER IF NOT EXISTS 'spells_test_user'@'%' IDENTIFIED BY 'spells_test_password';
GRANT SELECT, INSERT, UPDATE, DELETE ON spells_test_db.* TO 'spells_test_user'@'%';
